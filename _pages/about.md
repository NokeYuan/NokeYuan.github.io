...
<div class="experience-list">
  ...
  <div class="experience">
    <div class="dates">May 2025 – Oct 2025<br><span class="location" style="font-size:0.8rem; color: var(--global-text-color-light);">Toronto, Canada</span></div>
    <div class="details">
      <div class="place">UHN AI Hub</div>
      <div class="role">Machine Learning Engineer Intern</div>
      <div class="description">Designed and developed Clinical-Camel-ASR, an end-to-end medical scribing framework extending Clinical Camel, converting doctor–patient conversations into structured clinical summaries using ASR and LLMs, with WangLab.</div>
    </div>
    <img class="logo" src="/assets/img/uhn.svg" alt="University Health Network logo" loading="lazy">
  </div>
  <div class="experience">
    <div class="dates">Jan 2022 – May 2022<br><span class="location" style="font-size:0.8rem; color: var(--global-text-color-light);">London, UK</span></div>
    <div class="details">
  ...
  <div class="experience">
    <div class="dates">Apr 2020 – Sep 2020<br><span class="location" style="font-size:0.8rem; color: var(--global-text-color-light);">Beijing, China</span></div>
    <div class="details">
      <div class="place">NetEase</div>
      <div class="role">Data Analyst Intern</div>
      <div class="description">Statistical risk models over 1M+ user records for supplier risk management and strategic decision-making.</div>
    </div>
    <img class="logo" src="/assets/img/netease.png" alt="NetEase logo" loading="lazy">
  </div>
</div>

<h2 class="experience-heading">Education</h2>

<div class="experience-list">
  <div class="experience">
    <div class="dates">Sep 2022 – Present<br><span class="location" style="font-size:0.8rem; color: var(--global-text-color-light);">Toronto, Canada</span></div>
    <div class="details">
      <div class="place">University of Toronto</div>
      <div class="role">PhD, AI in Healthcare — <a href="https://ims.utoronto.ca/">Institute of Medical Science</a></div>
  ...
  <div class="experience">
    ...
    <div class="details">
      ...
      <div class="description">Health data science across electronic health records, imaging, and genomics.</div>
    </div>
    <img class="logo" src="/assets/img/ucl.svg" alt="UCL logo" loading="lazy">
  </div>
  <div class="experience">
    <div class="dates">Sep 2015 – Nov 2019<br><span class="location" style="font-size:0.8rem; color: var(--global-text-color-light);">Toronto, Canada</span></div>
    <div class="details">
      <div class="place">University of Toronto</div>
      <div class="role">HBSc, Computer Science Specialist &amp; Statistics Major — <a href="https://web.cs.toronto.edu/">Department of Computer Science</a> (St. George)</div>
